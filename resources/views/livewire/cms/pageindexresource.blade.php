<div class="py-12 mx-auto max-w-5xl flex flex-col min-h-screen">
    ...
    <div class="space-y-4">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('cms.data.resource.insert', ['locale' => app()->getLocale()]) }}"
                class="px-4 py-2 border font-medium hover:bg-gray-100">
                + Tambah Data
            </a>
        </div>

        <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari title..."
    ...
    <div class="border mt-4">
        ...
        <div class="grid grid-cols-12 bg-gray-100 border-b text-sm font-semibold">
            <div class="col-span-10 px-4 py-3">Title</div>
        ...
        @forelse ($resources as $item)
            <div
                ...
                <!-- CLICKABLE ROW -->
                <a href="{{ route('cms.data.resource.edit', [
                    'locale' => app()->getLocale(),
                    'id' => $item->id
                ]) }}" class="col-span-10 hover:bg-gray-50">
