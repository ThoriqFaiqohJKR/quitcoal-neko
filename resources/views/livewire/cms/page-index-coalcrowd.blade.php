<div class="py-12 mx-auto max-w-5xl flex flex-col">
    ...
    <div class="space-y-4">
        <div class="flex justify-between items-center">
            <h1 class="text-xl font-semibold">Coalcrowd</h1>

            <a href="{{ route('cms.background.coalcrowd.insert', ['locale' => app()->getLocale()]) }}"
    ...
    <div class="border mt-4">
        <div class="grid grid-cols-12 bg-gray-100 border-b text-sm font-medium">
            ...
            <div class="col-span-2 px-3 py-2">Sumber</div>
            <div class="col-span-2 px-3 py-2 text-center">Aksi</div>
        </div>

        @forelse ($coalcrowds as $item)
            <div class="relative grid grid-cols-12 border-b text-sm items-start hover:bg-gray-50 {{ $loop->even ? 'bg-gray-100' : 'bg-white' }}">

                <a href="{{ route('cms.background.coalcrowd.edit', [
                ...
                <div class="col-span-2 px-3 py-2 text-center relative z-30"
                     x-data="{ open: false }"
                     @click.stop>

                    <button type="button"
                            @click="open = true"
                            class="px-2 py-1 border hover:bg-red-100">
                        Hapus
                    </button>
                    ...
                    <div x-show="open"
                        ...
                        <div @click.outside="open = false"
                             class="bg-white border w-full max-w-sm p-4 text-left">
