<div class="py-12 mx-auto max-w-5xl flex flex-col min-h-screen">
    ...
    <div class="space-y-4">
        <div class="flex justify-between items-center">
            <h1 class="text-xl font-semibold">Regulation</h1>

            <a href="{{ route('cms.background.regulation.insert', ['locale' => app()->getLocale()]) }}"
    ...
    <div class="border mt-4">
        <div class="grid grid-cols-12 bg-gray-100 border-b text-sm font-semibold">
            ...
            <div class="col-span-6 px-4 py-3">Deskripsi</div>
        ...
        @forelse ($regulations as $item)
                <div
                    ...
                    <a href="{{ route('cms.background.regulation.edit', [
                'locale' => app()->getLocale(),
                'id' => $item->id
            ]) }}" class="col-span-10 grid grid-cols-10 hover:bg-gray-50">

                        <div class="col-span-4 px-4 py-3 font-medium text-gray-900">
                            {!! ($this->titlePreview)($item) !!}
                        </div>

                        <div class="col-span-6 px-4 py-3 text-gray-700 leading-relaxed">
