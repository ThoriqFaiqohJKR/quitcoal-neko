...
class Pageeditaction extends Component
{
    use WithFileUploads;
    ...
    public function update()
    {
        ...
        if ($this->flayer_en) {
            $flayerEnPath = $this->flayer_en->store('action', 'public');
        }
        ...
        DB::table('action')->where('id', $this->id)->update([
    ...
    {
        return view('livewire.cms.pageeditaction');
    }
}
