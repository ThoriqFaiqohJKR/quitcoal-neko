<div>
    ...
    <div class="container mx-auto px-4 max-w-6xl py-12 space-y-8">
        ...
        <div class="border border-gray-300 bg-white">
            ...
            <form wire:submit.prevent="save" class="grid grid-cols-1 md:grid-cols-2 gap-6 px-6 py-6">
                ...
                <div class="md:col-span-2 flex justify-between pt-6">
                    ...
                    <button type="submit" class="border border-blue-600 bg-blue-600 px-6 py-2 text-sm font-semibold text-white">Simpan</button>
                </div>
