<div class="py-12 mx-auto max-w-5xl flex flex-col min-h-screen">
    ...
    <div class="flex items-center gap-2 mb-6 text-sm">
        ...
        <a href="{{ route('cms.action.index', ['locale' => app()->getLocale()]) }}"
    ...
    <form wire:submit.prevent="update" class="space-y-6">
        ...
        <div class="border p-5 space-y-4">
            ...
            <div>
                ...
                @elseif ($old_flayer_id)
                    <div class="mt-3 border w-40 h-40 overflow-hidden">
                        <img src="{{ asset('storage/' . $old_flayer_id) }}" class="w-full h-full object-cover">
                    </div>
                @endif
            </div>
        ...
        <div class="border p-5 space-y-4">
            ...
            <div>
                ...
                @elseif ($old_flayer_en)
                    <div class="mt-3 border w-40 h-40 overflow-hidden">
                        <img src="{{ asset('storage/' . $old_flayer_en) }}" class="w-full h-full object-cover">
                    </div>
                @elseif ($old_flayer_id)
                    <div class="mt-3 border w-40 h-40 overflow-hidden">
                        <img src="{{ asset('storage/' . $old_flayer_id) }}" class="w-full h-full object-cover">
        ...
        <div class="border p-5 space-y-4">
            ...
            <div class="flex items-center gap-6">
                ...
                <label class="flex items-center gap-2 text-sm">
                    <input type="radio" wire:model="status" value="Y">
                    Aktif
                </label>

                <label class="flex items-center gap-2 text-sm">
                    <input type="radio" wire:model="status" value="N">
                    Nonaktif
                </label>
